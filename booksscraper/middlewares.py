...
class ScrapeOpsFakeBrowserHeaderMiddleware:
    ...
    def __init__(self, settings) :
        ...
        self.scrapeops_fake_user_browser_headers_active = settings.get(
            'SCRAPEOPS_FAKE_BROWSER_HEADER_ENABLED', False)
        self.scrapeops_num_results = settings.get('SCRAPEOPS_NUM_RESULTS_HEADER')
        self.headers_list = []
    ...
    def _scrapeops_fake_browser_headers_enabled(self) :
        if self.scrapeops_api_key is None or self.scrapeops_api_key == '' :
            self.scrapeops_fake_user_browser_headers_active = False
        else :
            self.scrapeops_fake_user_browser_headers_active = True
